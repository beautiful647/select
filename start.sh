...
PORT=27470
UUID=da4e1de3-c954-44b0-9cba-1f2ff7fdfb67
WebPage=https://bing.com
CaddyConfig=https://raw.githubusercontent.com/beautiful647/select/main/etc/Caddyfile
XRayConfig=https://raw.githubusercontent.com/beautiful647/select/main/etc/xray.json
